...
private:
    ...
    ktx_transcode_fmt_e m_ktx_preferred_transcode_format;
    ...
    static auto select_preferred_ktx_transcode_format(const vk::raii::PhysicalDevice& physical_device) -> ktx_transcode_fmt_e;
};
