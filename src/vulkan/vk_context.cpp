...
auto VulkanContext::create(sdl::SdlWindow& window) -> std::unique_ptr<VulkanContext> {
    ...
    auto instance = create_instance(raii_context, debug_utils_enable);
...
auto VulkanContext::get_physical_device_vulkan13_properties(const vk::raii::PhysicalDevice& physical_device) -> vk::PhysicalDeviceVulkan13Properties {
    auto sc = physical_device.getProperties2<vk::PhysicalDeviceProperties2, vk::PhysicalDeviceVulkan13Properties>();
