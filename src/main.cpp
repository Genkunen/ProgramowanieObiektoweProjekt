...
auto sdl_entry_main() -> void {
    ...
    auto [sphere_vertices, sphere_indices] = make_sphere_mesh_data(16, 16, 0.01f);
    ...
    while (running) {
        ...
        auto render_result = renderer.render_frame(mesh_pool, sphere_mesh, imgui.draw_data());
